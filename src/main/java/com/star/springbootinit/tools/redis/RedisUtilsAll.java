package com.star.springbootinit.tools.redis;
 ...
 *
 * @author: Star
 * @Description: com.star.staroj.utils
 * @Version: 1.0
 */
@Component
public class RedisUtilsAll {

    /** redis 操作模板 */
    private final StringRedisTemplate redisTemplate;

    public RedisUtilsAll(StringRedisTemplate redisTemplate) {
